		...
		<!-- BEGIN : Process Form -->
		<div id='process-form'>
			<form id='main-form' name='main-form' method='post' action='<?php echo base_url() ?>akun/transaksiPengeluaran/addAct'>
				<table id='tbl-top' border='0' cellpadding='0' cellspacing='0'>
					<tbody>
						...
						<tr>
							...
							<td class='input'>
								<select id="id_pihak_penerima" name='id_pihak_penerima' class='required' style='width: 200px;'>
						...
						<tr>
							...
							<td class='input'><input name='pajak' type='text' class='number'/>&nbsp;%</td>
						</tr>	
						<tr>
		...
		<script language='javascript' type='text/javascript'>
			...
			function rubahJenisTransaksi(elm) {
				...
				oForm = elm.form;				
				removeOptions(oForm.id_pihak_penerima, '');
				changeOptions(elm, oForm.id_pihak_penerima, 'trans.jenis_transaksi_pihak_penerima_v', 'pihak_penerima', 'id_pihak_penerima', 'ORDER BY pihak_penerima', false, false);
				$("#id_pihak_penerima").chosen();
			}
			//-->
		</script>
		<!-- END : Process Form -->
