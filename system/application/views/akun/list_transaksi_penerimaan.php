  		...
  		<div id='act-bar'>
  			<div class='non-print-act'>
				...
				<a class='act-button' href="javascript: openPop('akun/transaksiPenerimaan/add', 'tambah');">
					<img src='<?php echo $img_folder; ?>/add.gif' border='0' alt='Tambah' align='absmiddle'/>Tambah
				</a>
				<?php } ?>
				<?php if ($s4b_password->getAccess('hapus')) { ?>
				<a class='act-button' href="javascript: delForm('main-form', 'akun/transaksiPenerimaan/del');">
  			...
  			<div class='print-act'>
				...
				<a class='act-button' href="javascript: openPop('akun/transaksiPenerimaan/report/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'report');">
  					...
  					<tbody>
  						...
  						<tr>
  							...
  							<td class='td-edit'>
							  	...
							  	<a href="javascript: openPop('akun/transaksiPenerimaan/edit/<?php echo $transaksi['id_transaksi']; ?>/<?php echo $page; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'edit');"><img src='<?php echo $img_folder; ?>/edit.gif' border='0' alt='Edit'/></a>
							  	<?php } else { ?>
							  	&nbsp;
							  	<?php } ?>
							</td>
