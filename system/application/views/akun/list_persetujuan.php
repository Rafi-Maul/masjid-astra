  		...
  		<div id='act-bar'>
  			<div class='print-act'>
				...
				<a class='act-button' href="javascript: openPop('akun/persetujuan/report/<?php echo $flag; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'report');">
  					...
  					<tbody>
  						...
  						<tr>
  							...
  							<td class='td-edit'>
							  	...
							  	<a href="javascript: openPop('akun/persetujuan/edit/<?php echo $jurnal['id_akmt_jurnal']; ?>/<?php echo $flag; ?>/<?php echo $page; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'edit', 650, 500);"><img src='<?php echo $img_folder; ?>/edit.gif' border='0' alt='Edit Persetujuan'/></a>
							  	<?php } else { ?>
							  	&nbsp;
							  	<?php } ?>
							</td>
							<td align='center'>
								...
								<a title='Tampilkan bukti pembukuan' href="javascript: openPop('akun/persetujuan/voucher/<?php echo $jurnal['id_akmt_jurnal']; ?>/<?php echo $flag; ?>', 'report');">
