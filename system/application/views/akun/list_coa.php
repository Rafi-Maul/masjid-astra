  		...
  		<div id='act-bar'>
  			<div class='non-print-act'>
				...
				<a class='act-button' href="javascript: openPop('akun/coa/add', 'tambah');">
					<img src='<?php echo $img_folder; ?>/add.gif' border='0' alt='Tambah' align='absmiddle'/>Tambah
				</a>
				<?php } ?>
				<?php if ($s4b_password->getAccess('hapus')) { ?>
				<a class='act-button' href="javascript: delForm('main-form', 'akun/coa/del');">
  			...
  			<div class='print-act'>
				...
				<a class='act-button' href="javascript: openPop('akun/coa/report/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'report');">
					...
					<tr>
						...
						<td>
							<select name='filter'>
							  ...
							  <option value='2' <?php if ($filter == 2) { ?>selected<?php } ?>>No. COA</option>
							</select>
						</td>
						<td>
  				...
  				<table id='tbl' width='100%' border='0' cellpadding='3' cellspacing='0'>
  					...
  					<tbody>
  						...
  						<tr>
  							...
  							<td class='td-check'><input type='checkbox' name='id_list[]' value='<?php echo $coa['id_akdd_detail_coa']; ?>'/></td>
  							<td class='td-edit'>
  								<?php if ($s4b_password->getAccess('edit')) { ?>
							  	<a href="javascript: openPop('akun/coa/edit/<?php echo $coa['id_akdd_detail_coa']; ?>/<?php echo $page; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'edit');"><img src='<?php echo $img_folder; ?>/edit.gif' border='0' alt='Edit'/></a>
							  	<?php } else { ?>
							  	&nbsp;
							  	<?php } ?>
							</td>
							<td><?php echo $coa['uraian_main_coa']; ?></td>
  							<td align='center'><?php echo $coa['level_number']; ?>&nbsp;</td>
  							<td align='center'><?php echo $coa['coa_number']; ?>&nbsp;</td>  							
  							<td style='padding-left: <?php echo ((10 * ($coa['level_number'] - 1)) + 5); ?>px;'><?php echo $coa['uraian']; ?>&nbsp;</td>
  						</tr>  						
  						<?php
  							}  						
  						?>
