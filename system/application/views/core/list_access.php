  		...
  		<div id='act-bar'>
  			<div class='print-act'>
				...
				<a class='act-button' href="javascript: openPop('core/access/report/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'report');">
			...
			<form name='search-form' action='<?php echo site_url($this->uri->uri_string()); ?>' method='post'>
				<table border='0' cellspacing='0' cellpadding='2'>
					<tr>
						...
						<td>
							<select name='filter'>
							  <option value='1' <?php if ($filter == 1) { ?>selected<?php } ?>>Access Name</option>							
							  <option value='2' <?php if ($filter == 2) { ?>selected<?php } ?>>Access Code</option>
							</select>
						</td>
						<td>
  				...
  				<table id='tbl' width='100%' border='0' cellpadding='3' cellspacing='0'>
  					<thead>
  						<tr>
  							...
  							<th width='100'>Access Name</th>
  							<th width='100'>Access Code</th>
  							<th>Keterangan</th>
						</tr>		
  					</thead>
  					<tbody>
  						...
  						<tr>
  							...
  							<td align='right'><?php echo $access['access_code']; ?>&nbsp;</td>
  							<td><?php echo $access['note']; ?>&nbsp;</td>
  						</tr>  						
  						<?php
  							}  						
  						?>
