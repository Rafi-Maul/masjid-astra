				...
				<table id='tbl-top' border='0' cellpadding='0' cellspacing='0'>
					<tbody>
						...
						<tr>
							...
							<td class='input'>
								<textarea name='nama_rek' rows='3' cols='45'><?php echo $penerima['nama_rek']; ?></textarea>
							</td>
						</tr>
						<tr>
							<td class='label'>Nomor Rekening</td>
							<td class='input'><input type='text' name='no_rek' size='45' value="<?php echo $penerima['no_rek']; ?>"/></td>
						</tr>
						<tr>
							<td class='label'>Bank</td>
							<td class='input'>
								<textarea name='nama_bank' rows='3' cols='45'><?php echo $penerima['nama_bank']; ?></textarea>
							</td>
						</tr>						
						<tr>
