		...
		<!-- BEGIN : Process Form -->
		<div id='process-form'>
			<form id='main-form' name='main-form' method='post' action='<?php echo base_url() ?>basic/<?php echo $tipe; ?>/addAct'>
				<table id='tbl-top' border='0' cellpadding='0' cellspacing='0'>
					<tbody>
						...
						<tr>
							...
							<td class='input'><input type='text' name='no_hp' size='45'/></td>
						</tr>													
						<tr>
						...
						<tr>
							...
							<td class='input'>
								<textarea name='nama_rek' rows='3' cols='45'></textarea>
							</td>
						</tr>
						<tr>
							<td class='label'>Nomor Rekening</td>
							<td class='input'><input type='text' name='no_rek' size='45'/></td>
						</tr>
						<tr>
							<td class='label'>Bank</td>
							<td class='input'>
								<textarea name='nama_bank' rows='3' cols='45'></textarea>
							</td>
						</tr>						
						<tr>
							<td class='label' colspan='2'>&nbsp;</td>
