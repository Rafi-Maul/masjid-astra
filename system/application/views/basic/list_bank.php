  		...
  		<div id='act-bar'>
  			<div class='non-print-act'>
				...
				<a title='Tambah' class='act-button' href="javascript: openPop('basic/bank/add', 'tambah');">
					<img src='<?php echo $img_folder; ?>/add.gif' border='0' alt='Tambah' align='absmiddle'/>Tambah
				</a>
				<?php } ?>
				<?php if ($s4b_password->getAccess('hapus')) { ?>
				<a title='Hapus' class='act-button' href="javascript: delForm('main-form', 'basic/bank/del');">
  			...
  			<div class='print-act'>
				...
				<a title='Laporan' class='act-button' href="javascript: openPop('basic/bank/report/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'report');">
					...
					<tr>
						...
						<td>
							<select name='filter'>
							  ...
							  <option value='2' <?php if ($filter == 2) { ?>selected<?php } ?>>Kota</option>
							</select>
						</td>
						<td>
  				...
  				<table id='tbl' width='100%' border='0' cellpadding='3' cellspacing='0'>
  					...
  					<tbody>
  						...
  						<tr>
  							...
  							<td class='td-check'>
								<input type='checkbox' name='id_list[]' value='<?php echo $bank['id_bank']; ?>'/>
							</td>
  							<td class='td-edit'>
  								<?php if ($s4b_password->getAccess('edit')) { ?>
							  	<a href="javascript: openPop('basic/bank/edit/<?php echo $bank['id_bank']; ?>/<?php echo $page; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'edit');"><img src='<?php echo $img_folder; ?>/edit.gif' border='0' alt='Edit'/></a>
							  	<?php } else { ?>
							  	&nbsp;
							  	<?php } ?>
							</td>
							<td><?php echo $bank['nama']; ?>&nbsp;</td>							
  							<td><?php echo $bank['kota']; ?>&nbsp;</td>  							
  							<td><?php echo $bank['keterangan']; ?>&nbsp;</td>  							
  						</tr>  						
  						<?php
  							}  						
  						?>
