  			...
  			<form id='main-form' method='post' action=''>
  				<table id='tbl' width='100%' border='0' cellpadding='3' cellspacing='0'>
  					...
  					<tbody>
  						<?php
  							$i = $s4b_paging['start'];
  							foreach ($arr_penerima as $penerima) {
  						?>
  						<tr>
  							<td class='td-no'><?php echo ++$i; ?>.</td>
  							<td class='td-check'>
								<input type='checkbox' name='id_list[]' value='<?php echo $penerima['id_pihak_penerima']; ?>'/>
							</td>
  							<td class='td-edit'>
  								<?php if ($s4b_password->getAccess('edit')) { ?>
							  	<a href="javascript: openPop('<?php echo base_url() ?>basic/<?php echo $tipe; ?>/edit/<?php echo $penerima['id_pihak_penerima']; ?>/<?php echo $page; ?>/<?php echo $filter; ?>/<?php echo $keyword; ?>', 'edit');"><img src='<?php echo $img_folder; ?>/edit.gif' border='0' alt='Edit'/></a>
							  	<?php } else { ?>
							  	&nbsp;
							  	<?php } ?>
							</td>
							<td><?php echo $penerima['nama']; ?>&nbsp;</td>
  							...
  							<td><?php echo $penerima['no_hp']; ?>&nbsp;</td>
  							<td><?php echo $penerima['keterangan']; ?>&nbsp;</td>
  							<td><?php echo $penerima['nama_rek']; ?>&nbsp;</td>
  							<td><?php echo $penerima['no_rek']; ?>&nbsp;</td>
  							<td><?php echo $penerima['nama_bank']; ?>&nbsp;</td>
  						</tr>  						
  						<?php
  							}  						
  						?>
